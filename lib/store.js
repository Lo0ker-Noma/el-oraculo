...
export function nuevoMercado({ question, description, closes_at, resolves_at, anticipada = true }) {
  return {
    id: uid(),
    question,
    ...
    verdict: null,
    // Criterio dinamico: si el desenlace se vuelve irreversible antes de la
    // fecha limite (p.ej. el equipo queda eliminado), se resuelve ya.
    anticipada,
    ultima_revision: 0, // unix de la ultima comprobacion anticipada
    bets: [],
  };
}
